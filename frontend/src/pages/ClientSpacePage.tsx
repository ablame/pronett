...
<div class="parties"><div class="party"><h3>Prestataire</h3><p><strong>Cleaning 16</strong><br>Service professionnel de nettoyage<br>Tél : 06 10 85 49 18<br>topcleaning16@gmail.com</p></div><div class="party"><h3>Client</h3><p><strong>${quote.clientName}</strong><br>${quote.clientEmail}</p></div></div>
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 animate-fade-in">
        ...
        <label className="flex items-start gap-3 cursor-pointer mb-5 p-4 rounded-xl border-2 border-transparent hover:border-blue-100 hover:bg-blue-50 transition-all">
          ...
          <span className="text-sm text-slate-600 leading-relaxed">
            ...
            {' '}de Cleaning 16. Je reconnais que cette signature électronique a valeur contractuelle.
          </span>
        </label>
              ...
              <div>
                {quotes.length === 0 ? (
                  <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-10 text-center">
                    ...
                    <p className="text-slate-500 text-sm">Vos devis et factures apparaîtront ici dès que Cleaning 16 vous en enverra.</p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {quotes.map((quote) => {

...
function showBrowserNotif(order: Order) {
  ...
  new Notification('🔔 Nouvelle commande Cleaning 16', {
...
<div class="header"><div class="logo">🧹 Cleaning 16</div><div class="doc-type"><h1>${typeLabel}</h1><p>Réf : ${quote.reference}</p><p>Date : ${quote.createdAt}</p>${quote.validUntil ? `<p>Valide jusqu'au : ${quote.validUntil}</p>` : ''}</div></div>
<div class="parties"><div class="party"><h3>Prestataire</h3><p><strong>Cleaning 16</strong><br>Service professionnel de nettoyage<br>Tél : 06 10 85 49 18<br>topcleaning16@gmail.com</p></div><div class="party"><h3>Client</h3><p><strong>${quote.clientName}</strong><br>${quote.clientEmail}${quote.clientPhone ? `<br>${quote.clientPhone}` : ''}</p></div></div>
...
<div class="footer">Cleaning 16 — topcleaning16@gmail.com — 06 10 85 49 18 — Document généré le ${new Date().toLocaleDateString('fr-FR')}</div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-700 to-sky-600 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-slate-800">Cleaning 16 Pro</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
              placeholder="topcleaning16@gmail.com" className="input-field" autoFocus required />
          </div>
          <div>
      ...
      <header className="bg-gradient-to-r from-blue-700 to-blue-600 text-white sticky top-0 z-40 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg leading-none">Cleaning 16</h1>

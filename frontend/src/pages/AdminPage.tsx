...
<div class="parties"><div class="party"><h3>Prestataire</h3><p><strong>Cleaning 16</strong><br>Service professionnel de nettoyage<br>Tél : 06 10 85 49 18<br>contact@luminett.fr</p></div><div class="party"><h3>Client</h3><p><strong>${quote.clientName}</strong><br>${quote.clientEmail}${quote.clientPhone ? `<br>${quote.clientPhone}` : ''}</p></div></div>
...
<div class="footer">Cleaning 16 — contact@luminett.fr — 06 10 85 49 18 — Document généré le ${new Date().toLocaleDateString('fr-FR')}</div>
